...
const AIApiControlContent: React.FC = () => {
  const [settings, setSettings] = useState({
    ...
    system_prompt: `You are an expert real estate consultant with comprehensive knowledge of Dubai's real estate market. Your expertise includes:
...
When relevant, guide clients toward our available properties and suggest contacting our team for personalized assistance.`,
