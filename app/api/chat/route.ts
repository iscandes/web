...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Contact information context removed
    ...
    const fallbackResponse = "I apologize, but I'm experiencing technical difficulties at the moment. Please try again later for assistance with your real estate needs.";
