...
export default function ExpertPage() {
  ...
  // Removed sidebar state - menu relocated to footer
  ...
  // Enhanced auto-scroll functionality for smooth chat experience
  ...
  // Auto-scroll when messages change or AI is typing
  useEffect(() => {
  ...
  // Additional smooth scrolling during typing for enhanced UX
  useEffect(() => {
    if (isTyping) {
      const interval = setInterval(() => {
        scrollToBottom();
      }, 500); // Gentle scroll every 500ms while typing
...
How can I help you with your property requirements?`;
  ...
  return (
    <div className="min-h-screen bg-luxury-black text-white relative">
      {/* Minimal Top Header */}
      <div className="glass-dark border-b border-green-ocean/30 backdrop-blur-xl sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* Logo & Brand */}
            <div className="flex items-center space-x-4">
              <div className="w-10 h-10 bg-gradient-to-br from-green-ocean to-green-ocean-light rounded-xl flex items-center justify-center shadow-lg">
                <i className="ri-robot-2-line text-white text-xl"></i>
              </div>
              <div>
                <h1 className="text-lg font-bold bg-gradient-to-r from-white to-green-ocean-light bg-clip-text text-transparent">
                  AI Real Estate Expert
                </h1>
              </div>
            </div>
       ...
       {/* Menu relocated to footer for better UX */}

      {/* Enhanced Welcome Banner */}
      <div className="bg-gradient-to-r from-luxury-black via-luxury-black-light to-luxury-black border-b border-green-ocean/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-2">
              <i className="ri-sparkle-line text-green-ocean text-lg"></i>
              <span className="text-sm text-green-ocean font-medium">AI-Powered Property Intelligence</span>
              <i className="ri-sparkle-line text-green-ocean text-lg"></i>
            </div>
            <p className="text-gray-300 text-sm max-w-2xl mx-auto">
              Get instant insights on Dubai's real estate market with our advanced AI consultant. 
              Ask about properties, investment opportunities, market trends, and more.
            </p>
          </div>
        </div>
      </div>
