          ...
          >
            ...
            <div className="flex space-x-2">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={() => developer.id && handleDelete(developer.id)}
                className="flex-1 flex items-center justify-center space-x-2 px-4 py-2 bg-red-500/20 text-red-300 hover:bg-red-500/30 rounded-lg transition-colors"
              >
