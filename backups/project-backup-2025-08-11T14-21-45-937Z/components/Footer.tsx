  ...
  return (
    <footer className="bg-white/90 backdrop-blur-sm border-t border-green-ocean/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-green-ocean/10 rounded-full flex items-center justify-center text-green-ocean hover:bg-green-ocean hover:text-white transition-colors duration-200"
              >
        ...
        {/* Contact Info */}
        <div className="border-t border-green-ocean/20 mt-8 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-green-ocean/10 rounded-full flex items-center justify-center">
                <svg className="w-5 h-5 text-green-ocean" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <div>
                <p className="text-gray-900 font-medium">Phone</p>
                <p className="text-gray-900">056 498 6660</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-green-ocean/10 rounded-full flex items-center justify-center">
        ...
        {/* Copyright */}
        <div className="border-t border-green-ocean/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
