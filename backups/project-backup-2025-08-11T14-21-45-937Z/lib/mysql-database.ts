...
export class MySQLDatabase {
    ...
    try {
      ...
      const createTablesSQL = `
        ...
        CREATE TABLE IF NOT EXISTS site_settings (
          ...
          contact_email VARCHAR(255) DEFAULT 'admin@pcrealestate.ae',
    contact_phone VARCHAR(50) DEFAULT '056 498 6660',
    contact_address TEXT DEFAULT 'Dubai, UAE',
    contact_whatsapp VARCHAR(50) DEFAULT '+9710564986660',
    ...
    try {
      ...
      if (settings.length > 0) {
        ...
        return {
          ...
          contact: {
            email: dbSettings.contact_email || 'admin@pcrealestate.ae',
      phone: dbSettings.contact_phone || '056 498 6660',
      address: dbSettings.contact_address || 'Dubai, UAE',
      whatsapp: dbSettings.contact_whatsapp || '+9710564986660'
          },
          social: {
  ...
  static async updateSettings(settingsData: any): Promise<any> {
    try {
      ...
      contact_whatsapp: '+9710564986660',
          social_facebook: '',
          social_instagram: '',
          social_twitter: '',
          social_linkedin: '',
